export default [
...

  {
    ...
    color: '#3F5B98',
    category: 'Excuse me',
    subCategories: ['   When you need to get through but there’s someone blocking your way, say “Excuse me.”',
  ...
  
  {
    ...
    subCategories: ['   When you want to hear someone’s opinion on a topic, use this question.',
  ...
  },
   {
    ...
    subCategories: ['   If you suggest an idea or plan, use this phrase to find out what others think.',
...

   {
    ...
    subCategories: ['   We can say “please” either at the end of the question or right after “you,” like this:',
