...
import { TouchableOpacity, Alert, StatusBar, Dimensions, Animated, FlatList, Text, View, StyleSheet } from 'react-native';
import { SimpleLineIcons } from '@expo/vector-icons';

import data from '../LoginAnim/UI2';
const ICON_SIZE = 42; const ITEM_HEIGHT = ICON_SIZE * 2;
const colors = {
  yellow: '#FF78A3',
  dark: '#2D2D2D',
};
